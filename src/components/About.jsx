    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-5">
          ...
          <span className=" font-bold">Abdul Hameed.</span>
        </p>
        <p>
          A Front-End Developer who loves turning imagination into reality.
          <br />
          My enthusiasm lies in building innovative solutions on the internet,
          backed by strong organizational and communication skills, and a keen
          eye for writing efficient code.
          <br />
          Proficient in JavaScript, React.js, React Native and Redux, enabling
          me to build robust and scalable applications. Strong commitment to
          delivering high-quality, seamless user experiences.
        </p>
        ...
        <section className="pt-5">
          <p className="font-bold inline border-b-2 border-gray-500 text-xl">
            Tech Stack
          </p>
          <div>
            ...
            <div className="grid text-center sm:grid-cols-2 md:grid-cols-6">
              {programming.map((item) => (
                <div className="bg-orange-400 flex justify-center items-center py-2 px-4 mr-2 mb-2 rounded-lg cursor-pointer text-slate-300 hover:scale-110 hover:text-sky-400 duration-200">
