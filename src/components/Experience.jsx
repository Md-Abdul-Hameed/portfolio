          ...
          <div className="timeline">
            ...
            <div className="timeline-component timeline-content">
              ...
              <ul className="list-disc mt-2">
                <li>
                  Developed highly functional user interface for web application
                  leveraging React.JS to solve business problems
                </li>
                <li>
                  Solely designed and developed hybrid mobile application from
                  scratch using React Native
                </li>
                <li>
                  Implemented scalable, high-speed, reusable components using
                  ES6 concepts resulted in 35% code reduction
                </li>
                <li>
                  Collaborated with back-end team to integrate RESTful APIs to
                  collect JSON data using axios, ensuring seamless data flow by
                  reducing 15% time, used redux thunk for state management
                </li>
                <li>
                  Integrated JWT authentication, upload/download files, multiple
                  dashboards, server side data tables and pagination, complex
                  forms, infinite scrolling, background and foreground services,
                  data searching, etc
                </li>
                <li>
                  Implemented responsive and visually appealing UI to enhance
                  the user experience using modern CSS frameworks
                </li>
                <li>
                  Performed rigorous testing to identify and fix the bugs using
                  Chrome DevTools resulting in improving application performance
                  by 25%
                </li>
              </ul>
            </div>
            <div className="timeline-component timeline-content">
              {
                <div>
                  <h1>
                    ...
                    - <span className="font-bold text-sky-400">CLICKNFINANCE</span>
                  </h1>
                  <p className="inline border-b-2 border-gray-500 text-sm pb-1">
                    NOV 2022 - OCT 2023 | MP, India
                  </p>
                  <ul className="list-disc mt-2">
                    <li>
                      Developed highly functional user interface for web
                    ...
                    <li>
                      ...
                      to collect JSON data using axios, ensuring seamless data
                      flow by reducing 15% time, used redux thunk for state
                      management
                    </li>
                    <li>
