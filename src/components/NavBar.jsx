...
const NavBar = () => {
  ...
  return (
    ...
    drop-shadow-[0px_7px_5px_rgba(8,145,178,0.1)] z-50">
      <div>
        <Link to="home" smooth duration={500}>
          <h1 className="text-7xl text-slate-300 font-signature cursor-pointer hover:text-sky-400 hover:scale-110 duration-200">AH</h1>
        </Link>
      </div>
